...
<html lang="en">
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
            <div class="text">
              <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Home</a> Activities</span> </p>
              <h1 class="mb-4 bread">Activities</h1>
            </div>
          </div>
        </div>
      </div>
  ...
  $total_pages;
    $total_pages_sql;
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM activities";
  ...
  $query="SELECT * FROM activities LIMIT $offset, $no_of_records_per_page";
