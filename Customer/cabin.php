...
<html lang="en">
 ...
 <?php 
    ...
    $total_pages_sql;
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM cabin";
 ...
 $selroom=mysqli_query($conc,"SELECT * FROM cabin,cabintype WHERE cabin.ctid=cabintype.ctid LIMIT $offset, $no_of_records_per_page");
