...
<head>
	...
	<a class="active" href="AdminSignUp.php">SignIn</a>
	</div>
	</div>
	<div>
		<center>
		<h2>Sigup Form</h2>
		 <form action="signupPhp.php" method="POST">
			<div class="container">
				...
				<input type="text" name="name" placeholder="Eneter Your StaffID" required="">
				<label><b>Password</b></label>
				<input type="text" name="address" placeholder="Enter Your Password" required="">
				<label><b>Confirm Password</b></label>
				<input type="password" name="pwd" placeholder="Renter Your Password" required>
