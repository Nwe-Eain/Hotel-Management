...
<div id="sidebar"><a href="index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard
  ...
  <ul>
    ...
    <li class="active"> <a href="paymentlist.php"><i class="icon icon-signal"></i> <span> Payment List</span></a> </li>
...
<div id="content">
    ...
    <div class="row-fluid">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5> Check Customers's Complete Payment List</h5>
          </div>
 ...
 <?php 
 $i=1;
$sel=mysqli_query($conc,"SELECT c.custemail,c.custph,b.bprice,p.* FROM 
customers c,booking b,bookingcabin bc,bookigdetail bd,payment p
WHERE c.custId=b.custId AND bc.bid=b.bid AND bd.bcid=bc.bcid AND p.bid=b.bid Order by b.bid DESC");
