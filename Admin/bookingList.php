...
<div id="sidebar"><a href="index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard
  ...
  <ul>
    ...
    <li> <a href="paymentlist.php"><i class="icon icon-signal"></i> <span> Payment List</span></a> </li>
...
WHERE c.custId=b.custId AND bc.bid=b.bid AND bd.bcid=bc.bcid AND bc.cid=cb.cid Order by b.bid DESC");
 ...
 ?>
        ...
        <tr>
          ...
          <td> <a href="checkbooking.php?bid=<?php echo $bid; ?>" class="btn btn-info"> Check</a></td>
